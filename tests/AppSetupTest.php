...
class AppSetupTest extends SqliteBasedTestCase
{
    ...
    public function testSampleMigration(): void
    {
        ...
        $this->assertSame('2', $this->destination->getConnection()->fetchOne('SELECT COUNT(*) FROM fruits'));
        $this->assertSame('2', $this->destination->getConnection()->fetchOne('SELECT COUNT(*) FROM fruit_x_basket'));
        $this->assertSame('3', $this->source->getConnection()->fetchOne('SELECT COUNT(*) FROM baskets'));
        $this->assertSame('2', $this->destination->getConnection()->fetchOne('SELECT COUNT(*) FROM baskets'));
    }
